...
<link rel="stylesheet" type="text/css" href="<%= ResolveUrl("~/DesktopModules/Jacaranda2FA/AccountSecurity.css?v=00.00.28") %>" />
<script type="text/javascript" src="<%= ResolveUrl("~/DesktopModules/Jacaranda2FA/qrcode-local.js?v=00.00.28") %>"></script>
...
<div class="jacaranda2fa-account-security">
    ...
    <asp:Panel ID="pnlSecurity" runat="server">
        <header class="jacaranda2fa-security-header">
            ...
            <div class="jacaranda2fa-version">Jacaranda2FA 00.00.28</div>
        </header>
